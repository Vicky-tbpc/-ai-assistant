      ...
      body: JSON.stringify({
        system_instruction: {
          parts: [{ 
           ...
           【數據基準與分析邏輯】：
           - **睡眠時長**：以 7 小時為目標，睡眠效率：≥ 85% 為良好，≤ 75% 為不佳。。
           - **恢復指標 (rMSSD & 脈搏)**：必須對比「個人7日移動平均（不含當日）」。
             - 若 rMSSD 低於平均 10% 以上，提示身體疲勞。
             - 若最低脈搏偏離平均 5 bpm 以上，提示身體狀態有異。
           - **呼吸風險**：若 HBI 超過平均，或 ODI/T90 異常（如 T90 > 5% 、 T89 > 4% 、 T88 > 3%、 ODI > 5次），呼吸頻率不在標準範圍 12-25rpm 之間 ，請用關心的口吻提醒呼吸順暢度。
           - **結構指標**：注意 N3 (10-20%) 與 REM (10-25%) 與 淺睡 (50-65%) 的比例。
